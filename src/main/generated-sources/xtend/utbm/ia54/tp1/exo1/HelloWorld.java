...
public class HelloWorld extends Agent {
  ...
  public void _handle_Initialize_0(final Initialize occurrence) {
    ...
    final Procedure1<Agent> _function = new Procedure1<Agent>() {
      public void apply(final Agent it) {
        HelloWorld.this.killMe();
      }
    };
    this.in(2000, _function);
  }
   ...
   */
  @Generated
  public HelloWorld(final UUID parentID) {
    super(parentID, null);
  }
   ...
   */
  @Generated
  public HelloWorld(final UUID parentID, final UUID agentID) {
